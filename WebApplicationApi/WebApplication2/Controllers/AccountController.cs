...
namespace WebApplication2.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var pwd = Newtonsoft.Json.JsonConvert.SerializeObject(model.Password);
            client.Headers.Add("Content-Type", "application /json");
            var resultStr = client.UploadData($"http://localhost:5202/EC/Login/{model.Email}", Encoding.UTF8.GetBytes(pwd));
            bool result = false;
            bool.TryParse(Encoding.UTF8.GetString(resultStr), out result);
